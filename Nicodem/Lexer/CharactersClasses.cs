...
namespace Nicodem.Lexer
{
	...
	public struct CharactersClasses
	{
		...
		public static readonly RegEx<char> space = RegExFactory.Union (RegExFactory.Range (' ', (char)(' ' + 1)),
			                                           RegExFactory.Range ('\t', (char)('\t' + 1)),
			                                           RegExFactory.Range ('\r', (char)('\r' + 1)),
			                                           RegExFactory.Range ('\n', (char)('\n' + 1)),
			                                           RegExFactory.Range ('\v', (char)('\v' + 1)),
			                                           RegExFactory.Range ('\f', (char)('\f' + 1)));
		public static readonly RegEx<char> print = RegExFactory.Union (RegExFactory.Complement (RegExFactory.Union (RegExFactory.Range ((char)0, (char)32), RegExFactory.Range ((char)127, (char)160))), space);
