...
namespace Nicodem.Lexer
{
    ...
    public struct CharactersClasses
    {
        ...
        public static readonly RegEx<char> print = RegExFactory.Complement(RegExFactory.Union(RegExFactory.Range((char)0, (char)32), RegExFactory.Range((char)127, (char)160)));
