...
namespace Core.Tests
{
	...
	public class PartitionRefinementTests
	{
		...
		public void Basic_Partition_Test ()
		{
			...
			Assert.True(ListEquals(new LinkedListWithInit<int>{1,2,3}, divided[0].Intersection));
			Assert.True(ListEquals(new LinkedListWithInit<int>{4,5,6}, divided[0].Difference));
